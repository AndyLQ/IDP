...
namespace registering_try2.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class UsersController : Controller
    {
        private readonly WebSiteRatingDbContext _context;

        public UsersController(WebSiteRatingDbContext context)
        {
            _context = context;
        }
